function Scene2() {
  ...
  let dot1, dot2
  let dotSize = 152
  // let s2Yellow = 'rgba(255, 199, 26, 0.5)'
  let s2Red = 'rgba(237, 28, 36, 0.5)'
  let s2Green = 'rgba(0, 166, 81, 0.5)'
  ...
  this.draw = function () {
    ...
    // dot1
    dot1.setProperties(dotSize + x0.value() * 2, s2Red)
    dot1.randomness1(x1.value() / 10)
    dot1.checkDistance(dotSize)
    // dot2
    dot2.setProperties(dotSize + x4.value() * 2, s2Green)
